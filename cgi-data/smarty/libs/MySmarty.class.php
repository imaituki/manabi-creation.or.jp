...
class MySmarty extends Smarty {
	...
	function admin_school(){

		// ディレクトリ
		$this->compile_dir  = _DOCUMENT_ROOT . "/../cgi-data/smarty/templates_c/school/admin/";
		$this->template_dir = "../template/";
		...
		// テンプレート変数
		$this->assign( "template_header"    , _DOCUMENT_ROOT . "/school/admin/common/inc/header.tpl"     );
		$this->assign( "template_secondary" , _DOCUMENT_ROOT . "/school/admin/common/inc/secondary.tpl"  );
		$this->assign( "template_javascript", _DOCUMENT_ROOT . "/school/admin/common/inc/javascript.tpl" );
		$this->assign( "template_image"     , _DOCUMENT_ROOT . "/school/admin/common/inc/image.tpl"      );
		$this->assign( "template_image2"    , _DOCUMENT_ROOT . "/school/admin/common/inc/image2.tpl"     );
		$this->assign( "template_file"      , _DOCUMENT_ROOT . "/school/admin/common/inc/file.tpl"       );
		$this->assign( "template_pagenavi"  , _DOCUMENT_ROOT . "/school/admin/common/inc/pagenavi.tpl"   );
	...
	function front_school() {
		...
		// 変数 - インクルードパス
		$this->assign( "template_meta"       , _DOCUMENT_ROOT . "/common/include/meta.tpl"          );
		$this->assign( "template_header"     , _DOCUMENT_ROOT . "/common/include/school_header.tpl" );
		$this->assign( "template_footer"     , _DOCUMENT_ROOT . "/common/include/school_footer.tpl" );
		$this->assign( "template_javascript" , _DOCUMENT_ROOT . "/common/include/javascript.tpl"    );
