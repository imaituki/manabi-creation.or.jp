...
<?php /*%%SmartyHeaderCode:18546719615eabc1b7bd2831-72823126%%*/if(!defined('SMARTY_DIR')) exit('no direct access allowed');
$_valid = $_smarty_tpl->decodeProperties(array (
  ...
  'nocache_hash' => '18546719615eabc1b7bd2831-72823126',
  'function' => 
  array (
  ),
  'variables' => 
  ...
  'unifunc' => 'content_5eabc1b7c20b65_20455327',
),false); /*/%%SmartyHeaderCode%%*/?>
<?php if ($_valid && !is_callable('content_5eabc1b7c20b65_20455327')) {function content_5eabc1b7c20b65_20455327($_smarty_tpl) {?><!DOCTYPE html>
<html>
<head>
<meta charset="utf-8">
					...
					<form method="post" action="" id="formSearch" enctype="multipart/form-data">
						<div class="col-sm-4">
							...
							<div class="input-group">
								<input type="text" id="search_keyword" name="search_keyword" value="<?php echo (($tmp = @$_smarty_tpl->tpl_vars['_SESSION']->value['admin']['contact']['search']['POST']['search_keyword'])===null||$tmp==='' ? '' : $tmp);?>
