...
<?php /*%%SmartyHeaderCode:10274352075eaa64687edd69-30373347%%*/if(!defined('SMARTY_DIR')) exit('no direct access allowed');
$_valid = $_smarty_tpl->decodeProperties(array (
  ...
  'nocache_hash' => '10274352075eaa64687edd69-30373347',
  'function' => 
  array (
  ),
  'variables' => 
  ...
  'unifunc' => 'content_5eaa646883d5f9_75646781',
),false); /*/%%SmartyHeaderCode%%*/?>
<?php if ($_valid && !is_callable('content_5eaa646883d5f9_75646781')) {function content_5eaa646883d5f9_75646781($_smarty_tpl) {?><!DOCTYPE html>
<html>
<head>
<meta charset="utf-8">
					...
					<form method="post" action="" id="formSearch" enctype="multipart/form-data">
						<div class="col-sm-4">
							...
							<div class="input-group">
								<input type="text" id="search_keyword" name="search_keyword" value="<?php echo (($tmp = @$_smarty_tpl->tpl_vars['_SESSION']->value['school']['admin']['staff']['search']['POST']['search_keyword'])===null||$tmp==='' ? '' : $tmp);?>
