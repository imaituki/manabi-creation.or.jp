...
<?php /*%%SmartyHeaderCode:12976620665eaa74ed1a8490-30706732%%*/if(!defined('SMARTY_DIR')) exit('no direct access allowed');
$_valid = $_smarty_tpl->decodeProperties(array (
  ...
  'nocache_hash' => '12976620665eaa74ed1a8490-30706732',
  'function' => 
  array (
  ),
  'variables' => 
  ...
  'unifunc' => 'content_5eaa74ed215db5_18353655',
),false); /*/%%SmartyHeaderCode%%*/?>
<?php if ($_valid && !is_callable('content_5eaa74ed215db5_18353655')) {function content_5eaa74ed215db5_18353655($_smarty_tpl) {?><!DOCTYPE html>
<html>
<head>
<meta charset="utf-8">
...
<script src="/school/admin/common/js/plugins/datapicker/bootstrap-datepicker-import.js"></script>
						...
						<div class="col-sm-4">
							<div class="form-group">
								...
								<div class="input-daterange input-group" id="datepicker">
									...
									<input type="text" class="input-sm form-control datepicker" name="search_date_start" id="search_date_start" value="<?php echo (($tmp = @$_smarty_tpl->tpl_vars['_SESSION']->value['company']['information']['search']['POST']['search_date_start'])===null||$tmp==='' ? '' : $tmp);?>
" readonly>
									<span class="input-group-addon">～</span>
									<input type="text" class="input-sm form-control datepicker" name="search_date_end" id="search_date_end"  value="<?php echo (($tmp = @$_smarty_tpl->tpl_vars['_SESSION']->value['company']['information']['search']['POST']['search_date_end'])===null||$tmp==='' ? '' : $tmp);?>
" readonly>
								</div>
							</div>
						</div>
						<div class="col-sm-4">
							...
							<div class="input-group">
								<input type="text" id="search_keyword" name="search_keyword" value="<?php echo (($tmp = @$_smarty_tpl->tpl_vars['_SESSION']->value['school']['admin']['information']['search']['POST']['search_keyword'])===null||$tmp==='' ? '' : $tmp);?>
