...
<?php /*%%SmartyHeaderCode:19814799795eaa646793ee30-19146018%%*/if(!defined('SMARTY_DIR')) exit('no direct access allowed');
$_valid = $_smarty_tpl->decodeProperties(array (
  ...
  'nocache_hash' => '19814799795eaa646793ee30-19146018',
  'function' => 
  array (
  ),
  'variables' => 
  ...
  'unifunc' => 'content_5eaa646799ccf7_46341470',
),false); /*/%%SmartyHeaderCode%%*/?>
<?php if ($_valid && !is_callable('content_5eaa646799ccf7_46341470')) {function content_5eaa646799ccf7_46341470($_smarty_tpl) {?><!DOCTYPE html>
<html>
<head>
<meta charset="utf-8">
...
<div id="wrapper">
	<?php echo $_smarty_tpl->getSubTemplate ($_smarty_tpl->tpl_vars['template_secondary']->value, $_smarty_tpl->cache_id, $_smarty_tpl->compile_id, 0, null, array('action'=>"public",'manage'=>"teacher_role"), 0);?>
					...
					<form method="post" action="" id="formSearch" enctype="multipart/form-data">
						<div class="col-sm-4">
							...
							<div class="input-group">
								<input type="text" id="search_keyword" name="search_keyword" value="<?php echo (($tmp = @$_smarty_tpl->tpl_vars['_SESSION']->value['school']['admin']['teacher_role']['search']['POST']['search_keyword'])===null||$tmp==='' ? '' : $tmp);?>
