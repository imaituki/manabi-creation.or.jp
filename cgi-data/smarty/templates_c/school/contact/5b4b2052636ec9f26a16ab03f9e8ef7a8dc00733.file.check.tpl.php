<?php /* Smarty version Smarty-3.1.18, created on 2020-04-30 18:45:37
         compiled from "./check.tpl" */ ?>
<?php /*%%SmartyHeaderCode:9480396885eaa9e416f2e12-70277193%%*/if(!defined('SMARTY_DIR')) exit('no direct access allowed');
$_valid = $_smarty_tpl->decodeProperties(array (
  ...
  'nocache_hash' => '9480396885eaa9e416f2e12-70277193',
  'function' => 
  array (
  ),
  'variables' => 
  ...
  'unifunc' => 'content_5eaa9e41773f60_34369305',
),false); /*/%%SmartyHeaderCode%%*/?>
<?php if ($_valid && !is_callable('content_5eaa9e41773f60_34369305')) {function content_5eaa9e41773f60_34369305($_smarty_tpl) {?><?php if (!is_callable('smarty_function_html_select_ken')) include '/home/manabi-creation/cgi-data/smarty/libs/plugins/function.html_select_ken.php';
?><!DOCTYPE html>
<html lang="ja">
<head>
<meta charset="utf-8">
		...
		<div class="wrapper">
			<div class="center entry">
				<div class="box">
					...
					<form action="./?sc=<?php echo $_smarty_tpl->tpl_vars['displaySchool']->value['id_school'];?>
#form" method="post">
...
" />
							...
							<div class="col-sm-6 mb20 left">
								<button class="button _back" type="submit" formaction="./?sc=<?php echo $_smarty_tpl->tpl_vars['displaySchool']->value['id_school'];?>
"><i class="fas fa-caret-left"></i>修正する</button>
							</div>
							<div class="col-sm-6 right">
								<button id="send_button" class="button" type="submit" formaction="./send.php?sc=<?php echo $_smarty_tpl->tpl_vars['displaySchool']->value['id_school'];?>
">送信する<i class="fas fa-caret-right"></i></button>
							</div>
						</div>
					</form>
				</div>
