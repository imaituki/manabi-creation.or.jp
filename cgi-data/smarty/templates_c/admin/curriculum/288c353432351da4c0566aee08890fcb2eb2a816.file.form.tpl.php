...
" />
					...
					<div class="form-group required">
						...
						<div class="col-sm-4 col-md-2">
							<?php if ((($tmp = @$_smarty_tpl->tpl_vars['message']->value['ng']['color'])===null||$tmp==='' ? '' : $tmp)!=null) {?><p class="error"><?php echo $_smarty_tpl->tpl_vars['message']->value['ng']['color'];?>
</p><?php }?>
							<input type="color" name="color" class="form-control" value="#<?php echo (($tmp = @$_smarty_tpl->tpl_vars['arr_post']->value['color'])===null||$tmp==='' ? '' : $tmp);?>
">
						</div>
					</div>
					<div class="hr-line-dashed"></div>
