...
$_valid = $_smarty_tpl->decodeProperties(array (
  ...
  'nocache_hash' => '15353074795ea289a9d44f94-77635568',
  'function' => 
  array (
  ),
					...
					<form method="post" action="" id="formSearch" enctype="multipart/form-data">
						<div class="col-sm-4">
							...
							<div class="input-group">
								<input type="text" id="search_keyword" name="search_keyword" value="<?php echo (($tmp = @$_smarty_tpl->tpl_vars['_SESSION']->value['admin']['curriculum']['search']['POST']['search_keyword'])===null||$tmp==='' ? '' : $tmp);?>
