<?php /* Smarty version Smarty-3.1.18, created on 2020-03-31 14:38:53
         compiled from "..\template\index.tpl" */ ?>
<?php /*%%SmartyHeaderCode:1315911925e8339ddf17a41-61501070%%*/if(!defined('SMARTY_DIR')) exit('no direct access allowed');
$_valid = $_smarty_tpl->decodeProperties(array (
  ...
  'nocache_hash' => '1315911925e8339ddf17a41-61501070',
  'function' => 
  array (
  ),
  'variables' => 
  ...
  'unifunc' => 'content_5e8339de0fbca8_60627789',
),false); /*/%%SmartyHeaderCode%%*/?>
<?php if ($_valid && !is_callable('content_5e8339de0fbca8_60627789')) {function content_5e8339de0fbca8_60627789($_smarty_tpl) {?><!DOCTYPE html>
<html>
<head>
<meta charset="utf-8">
...
<div id="wrapper">
	<?php echo $_smarty_tpl->getSubTemplate ($_smarty_tpl->tpl_vars['template_secondary']->value, $_smarty_tpl->cache_id, $_smarty_tpl->compile_id, 0, null, array('action'=>"public",'manage'=>"recruit_category"), 0);?>
					...
					<form method="post" action="" id="formSearch" enctype="multipart/form-data">
						<div class="col-sm-4">
							...
							<div class="input-group">
								<input type="text" id="search_keyword" name="search_keyword" value="<?php echo (($tmp = @$_smarty_tpl->tpl_vars['_SESSION']->value['admin']['recruit_category']['search']['POST']['search_keyword'])===null||$tmp==='' ? '' : $tmp);?>
