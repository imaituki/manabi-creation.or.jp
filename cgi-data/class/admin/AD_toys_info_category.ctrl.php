...
class AD_toys_info_category {
	...
	// 主テーブル
	var $_CtrTable   = "mst_toys_info_category";
	var $_CtrTablePk = "id_toys_info_category";

	// コントロール機能（ログ用）
	var $_CtrLogName = "おもちゃカテゴリ";
	...
	function check( $arrVal, $mode ) {
		...
		if( ( strcmp( $mode, "update" ) == 0 ) ) {
			$objInputCheck->entryData( "おもちゃカテゴリID", "all", $arrVal[$this->_CtrTablePk], array( "CHECK_EMPTY", "CHECK_NUM" ), null, null );
		}
