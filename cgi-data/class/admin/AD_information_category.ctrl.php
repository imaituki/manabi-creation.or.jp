...
class AD_information_category {
	...
	// 主テーブル
	var $_CtrTable   = "mst_information_category";
	var $_CtrTablePk = "id_information_category";

	// コントロール機能（ログ用）
	var $_CtrLogName = "新着情報カテゴリ";
	...
	function check( $arrVal, $mode ) {
		...
		if( ( strcmp( $mode, "update" ) == 0 ) ) {
			$objInputCheck->entryData( "新着情報カテゴリID", "all", $arrVal[$this->_CtrTablePk], array( "CHECK_EMPTY", "CHECK_NUM" ), null, null );
		}
