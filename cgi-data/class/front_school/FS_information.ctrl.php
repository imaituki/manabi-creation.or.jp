...
class FS_information {
	...
	// 内  容：検索を行いデータを取得
	//-------------------------------------------------------
	function GetSearchList( $id_school, $search, $option = null, $limit = null ) {
	...
	function GetIdRow( $id_school, $id ) {
		...
		$creation_kit = array(  "select" => $this->_CtrTable . ".*, " . 
								...
								"where"  => $this->_CtrTable . ".date <= NOW() AND " . 
											...
											$this->_CtrTable . ".id_school = ? ", 
								"bind"   => array( "where" => array( $id, $id_school ) ) 
							);
	...
	//-------------------------------------------------------
	function GetDetailPageNavi( $id_school, $id ) {
		...
		$creation_kit = array(  "select" => $this->_CtrTable . "." . $this->_CtrTablePk,
								...
								"bind"   => array( "where" => array( $id_school ) ) 
							);
