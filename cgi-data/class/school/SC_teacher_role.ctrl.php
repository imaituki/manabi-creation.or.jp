...
class SC_teacher_role {
	...
	// 主テーブル
	var $_CtrTable   = "mst_teacher_role";
	var $_CtrTablePk = "id_teacher_role";
	...
	function check( $arrVal, $mode ) {
		...
		if( ( strcmp( $mode, "update" ) == 0 ) ) {
			$objInputCheck->entryData( "講師の役割ID", "all", $arrVal[$this->_CtrTablePk], array( "CHECK_EMPTY", "CHECK_NUM" ), null, null );
		}
