			...
			<table class="footable table table-stripped toggle-arrow-tiny tbl_1" data-page-size="15">
				...
				<tbody>
					{foreach from=$t_school_information item="information" name="loopSchoolInformation"}
					<tr>
						...
						<td><a href="./edit.php?id={$information.id_school_information}">{$information.title}</a></td>
						<td class="pos_al">
						...
						<td class="pos_ac">
							<div class="switch">
								<div class="onoffswitch">
									<input type="checkbox" value="1" class="onoffswitch-checkbox btn_display" id="display{$information.id_school_information}" data-id="{$information.id_school_information}"{if $information.display_flg == 1} checked{/if}>
									<label class="onoffswitch-label" for="display{$information.id_school_information}">
						...
						<td class="pos_ac">
							<a href="javascript:void(0)" class="btn btn-danger btn_delete" data-id="{$information.id_school_information}">削除</a>
						</td>
					</tr>
					{foreachelse}
					<tr>
