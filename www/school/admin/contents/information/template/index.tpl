...
<div id="wrapper">
	{include file=$template_secondary action="public" manage="information"}
						...
						<div class="col-sm-4">
							<div class="form-group">
								...
								<div class="input-daterange input-group" id="datepicker">
									...
									<input type="text" class="input-sm form-control datepicker" name="search_date_start" id="search_date_start" value="{$_SESSION.company.information.search.POST.search_date_start|default:""}" readonly>
									<span class="input-group-addon">～</span>
									<input type="text" class="input-sm form-control datepicker" name="search_date_end" id="search_date_end"  value="{$_SESSION.company.information.search.POST.search_date_end|default:""}" readonly>
								</div>
							</div>
						</div>
						<div class="col-sm-4">
							...
							<div class="input-group">
								<input type="text" id="search_keyword" name="search_keyword" value="{$_SESSION.school.admin.information.search.POST.search_keyword|default:""}" placeholder="キーワード" class="form-control">
