					...
					<form method="post" action="" id="formSearch" enctype="multipart/form-data">
						<div class="col-sm-4">
							...
							<div class="input-group">
								<input type="text" id="search_keyword" name="search_keyword" value="{$_SESSION.school.admin.staff.search.POST.search_keyword|default:""}" placeholder="キーワード" class="form-control">
