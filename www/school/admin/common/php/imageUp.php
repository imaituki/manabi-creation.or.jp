					...
					if( is_array( $_FILES[$val["name"]]["tmp_name"] ) ){
						...
						foreach ( $_FILES[$val["name"]]["tmp_name"] as $key3 => $val3) {
							...
							if( $originImage["extension"] < 1 || 3 < $originImage["extension"] ) {
								...
								// 出力
								$html  = "<img src=\"/school/admin/common/php/imageDisp.php?dir=" . $arr_post["_contents_dir"] . "&image=" . $val["name"] . "&time=" . strtotime("now") . "\" />&nbsp;";
								...
								// 画像をセッションに保存
								unset( $_SESSION["school"]["admin"][$arr_post["_contents_dir"]]["preview"][$val["name"]] );
								$_SESSION["school"]["admin"][$arr_post["_contents_dir"]]["preview"][$val["name"]]["type"]     = $_FILES[$val["name"]]["type"][$key3];
								$_SESSION["school"]["admin"][$arr_post["_contents_dir"]]["preview"][$val["name"]]["tmp_name"] = $pathInfo["dirname"] . "/s_" . $pathInfo["filename"] . $ext;
								$_SESSION["school"]["admin"][$arr_post["_contents_dir"]]["preview"][$val["name"]]["fn"]       = $fn;
						...
						if( $originImage["extension"] < 1 || 3 < $originImage["extension"] ) {
							...
							// 画像をセッションに保存
							unset( $_SESSION["school"]["admin"][$arr_post["_contents_dir"]]["preview"][$val["name"]] );
							$_SESSION["school"]["admin"][$arr_post["_contents_dir"]]["preview"][$val["name"]]["type"]     = $_FILES[$val["name"]]["type"];
							$_SESSION["school"]["admin"][$arr_post["_contents_dir"]]["preview"][$val["name"]]["tmp_name"] = $pathInfo["dirname"] . "/s_" . $pathInfo["filename"] . $ext;
							$_SESSION["school"]["admin"][$arr_post["_contents_dir"]]["preview"][$val["name"]]["fn"]       = $fn;
