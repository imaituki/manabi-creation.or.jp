		<div class="row border-bottom">
			<nav class="navbar navbar-static-top" role="navigation" style="margin-bottom: 0">
				...
				<ul class="nav navbar-top-links navbar-right">
					<li>
						<a href="/school/admin/logout.php"><i class="fa fa-sign-out"></i> Log out</a>
					</li>
				</ul>
			</nav>
{*
				...
				<ul class="nav navbar-top-links navbar-right">
					<li class="dropdown"> <a class="dropdown-toggle count-info" data-toggle="dropdown" href="#"> <i class="fa fa-envelope"></i> <span class="label label-warning">16</span> </a>
						<ul class="dropdown-menu dropdown-messages">
							<li>
								<div class="dropdown-messages-box"> <a href="bottom_template/profile.html" class="pull-left"> <img alt="image" class="img-circle" src="common/img/a7.jpg"> </a>
							...
							<li class="divider"></li>
							<li>
								<div class="dropdown-messages-box"> <a href="bottom_template/profile.html" class="pull-left"> <img alt="image" class="img-circle" src="common/img/a4.jpg"> </a>
							...
							<li class="divider"></li>
							<li>
								<div class="dropdown-messages-box"> <a href="bottom_template/profile.html" class="pull-left"> <img alt="image" class="img-circle" src="common/img/profile.jpg"> </a>
							...
							<li class="divider"></li>
							<li>
								<div class="text-center link-block"> <a href="bottom_template/mailbox.html"> <i class="fa fa-envelope"></i> <strong>Read All Messages</strong> </a> </div>
							</li>
						</ul>
					</li>
