		...
		<div class="wrapper">
			<div class="center entry">
				<div class="box">
					...
					<form action="./?sc={$displaySchool.id_school}#form" method="post">
...
*}
						...
						<div class="row form_button _check">
							...
							<div class="col-sm-6 mb20 left">
								<button class="button _back" type="submit" formaction="./?sc={$displaySchool.id_school}"><i class="fas fa-caret-left"></i>修正する</button>
							</div>
							<div class="col-sm-6 right">
								<button id="send_button" class="button" type="submit" formaction="./send.php?sc={$displaySchool.id_school}">送信する<i class="fas fa-caret-right"></i></button>
							</div>
						</div>
					</form>
				</div>
